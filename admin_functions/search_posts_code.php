...
<table class="table" style="width:57rem; float:right; margin-top:-22em" >
  ...
  if(isset($_POST["submit"]))
  {
    ...
    $sql = "SELECT * FROM  posts WHERE id LIKE '%$search%' OR title LIKE
    '%$search%' OR body  LIKE '%$search%' OR created_at LIKE '%$search%'";
    ...
    if($result > 0)
    {
      ...
      <td>
        <form action="delete_comment_code.php" method="post">
