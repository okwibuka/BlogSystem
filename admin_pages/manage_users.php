...
<div class="search_button mt-4" style="position:relative; left:40%; bottom:7px;">
    <form action="../admin_functions/search_users_code.php" method="post" style="position:absolute;">
...
<tr>
      ...
      <td>
        ...
        <form action="../admin_functions/delete_user_code.php" method="post" class="d-inline">
